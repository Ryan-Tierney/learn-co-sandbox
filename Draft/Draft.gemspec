...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{"A list of names and summaries for the top ten players in the 2020 NFL Draft."}
  spec.description   = %q{"Uses Sportingnew.com to scrape a list of names and summaries for prospects entering the 2020 NFL Draft."}
  ...
  if spec.respond_to?(:metadata)
    spec.metadata["allowed_push_host"] = "https://github.com/Ryan-Tierney/NFL_Prospects-"
